...
0
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header.htm', 1459754055, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/common/userabout.htm', 1459754055, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_userabout.htm', 1459754055, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/common/header_common.htm', 1459754055, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_diy.htm', 1459754055, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header_personalnv.htm', 1459754055, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
;?>
...
<div class="bm">
<div class="bm_h">
<?php if($space['self']) { ?><span class="xi2 y"><a href="forum.php?mod=misc&amp;action=nav" onclick="showWindow('nav', this.href, 'get', 0)" class="addnew">发帖</a></span><?php } ?>
<h1 class="mt">
...
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
<?php if($_G['setting']['homestyle']) { ?><a href="home.php"><?php echo $_G['setting']['navs']['4']['navname'];?></a> <em>&rsaquo;</em> <?php } ?>
<a href="home.php?mod=space&amp;do=blog">帖子</a>
</div>
</div>
<style id="diy_style" type="text/css"></style>
<div class="wp">
...
<?php if($list) { if(is_array($list)) foreach($list as $stid => $thread) { ?><tr<?php if($actives['me'] && $viewtype=='reply' || $viewtype=='postcomment') { ?> class="bw0_all"<?php } ?>>
<td class="icn">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;highlight=<?php echo $index['keywords'];?>" title="新窗口打开" target="_blank">
...
<td>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $thread['fid'];?>" class="xg1" target="_blank"><?php echo $forums[$thread['fid']];?></a>
</td>
<?php if($viewtype != 'postcomment') { if(!$actives['me']) { ?>
<td>
...
<td class="num">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>" class="xi2" target="_blank"><?php echo $thread['replies'];?></a>
<em><?php echo $thread['views'];?></em>
</td>

<?php if($actives['me']) { ?>
<td class="by">
<cite><a href="home.php?mod=space&amp;username=<?php echo $thread['lastposterenc'];?>" target="_blank"><?php echo $thread['lastposter'];?></a></cite>
...
<?php if($actives['me'] && $viewtype=='reply') { if(is_array($tids[$stid])) foreach($tids[$stid] as $pid) { $post = $posts[$pid];?><tr>
<td colspan="5" class="xg1">&nbsp;<img src="<?php echo IMGDIR;?>/icon_quote_m_s.gif" style="vertical-align:middle;" /> <a href="forum.php?mod=redirect&amp;goto=findpost&amp;ptid=<?php echo $thread['tid'];?>&amp;pid=<?php echo $pid;?>" target="_blank"><?php if($post['message']) { ?><?php echo $post['message'];?><?php } else { ?>......<?php } ?></a> <img src="<?php echo IMGDIR;?>/icon_quote_m_e.gif" style="vertical-align:middle;" /></td>
</tr>
